...
tools: ["mcp__flashduty__list_teams", "mcp__flashduty__list_members", "mcp__flashduty__list_schedules", "mcp__flashduty__get_channel", "mcp__flashduty__list_channels"]
parallel: true
---
...
1. **按频道**：获取频道 → 获取团队 → 获取值班
2. **按事件**：获取事件 → 获取频道 → 获取值班
3. **直接搜索**：按名称查询成员/团队
